...
projects = {
  ...
  "<span class = 'project'>> GoLocal</span><br><span class = 'projectdes'>an ecommerce website for hawkers mainly thellawallahs as well as customers to sell and buy things with decentralized payment integration</span>":
    "https://github.com/biswajit150803/GoLocal",
  "<span class = 'project'>> Sasta Bazar</span><br><span class = 'projectdes'>This project is built using Next Js and Sanity CLI where users can shop for fruits and add to cart and also payment integration is done using Stripe</span>":
    "https://github.com/biswajit150803/ecommerce_stripe",
  "<span class = 'project'>> Youtube Clone</span><br><span class = 'projectdes'>A youtube clone made using React JS and Rapid API where users can play videos without ads</span>":
    "https://github.com/biswajit150803/youtube_clone",
  "<span class = 'project'>> 47Bita Pods</span><br><span class = 'projectdes'>47BitaPods is a real estate company website where users can book their coworking spaces from list of available places and time slots</span>":
    "https://github.com/biswajit150803/47BitaPodsv2.0",
  "<span class = 'project'>> Lyriks</span><br><span class = 'projectdes'>A music player app made using React 18 and shazam core api</span>":
    "https://github.com/biswajit150803/lyriks",
};

links = {
  "<br>> Github": "https://github.com/biswajit150803",
  "> LinkedIn": "https://www.linkedin.com/in/biswajit-ghosh-2b0111219/",
  "> Twitter": "https://twitter.com/biswajit150803",
...
function command_handler(command) {
  ...
  switch (command.toLowerCase()) {
    ...
    case "cat aboutme.txt":
      content.innerHTML += `<br>I am a motivated Full Stack Developer with experience in MERN stack development, Web3, Solidity, and Next.js. As an intern at IQApex Labs, I contributed to the development of web applications, collaborating with cross-functional teams to implement features and optimize performance. I also explored the exciting realms of Web3 and Solidity for blockchain development.<br>`;
      break;
    case "fortune":
    ...
    case "cat photo.png":
      content.innerHTML += 
      "<br>Check my photo: <a href='https://drive.google.com/file/d/19mMlQuqssRlioHyxDrmfKQFIS7I23nKu/view?usp=drive_link' download>Photo.png</a><br>";
      break;

    case "contact":
      content.innerHTML += "<br>Contact Information:<br>";
      content.innerHTML +=
        "<br>Email: <a href='mailto:biswajitghosh150803@gmail.com'>biswajitghosh150803@gmail.com</a><br>";
      content.innerHTML +=
        "LinkedIn: <a href='https://www.linkedin.com/in/biswajit-ghosh-2b0111219/'>https://www.linkedin.com/in/biswajit-ghosh-2b0111219/</a><br>";
      break;
    ...
    case "cat resume.pdf":
      ...
      // );
      content.innerHTML +=
      "<br>Download my resume: <a href='https://drive.google.com/file/d/1eufMybxGP8sO-B90z_YK7owDk2F4yamg/view?usp=drive_link' download>Resume.pdf</a><br>";
      break;

    // Inside the switch statement of command_handler function
    case "testimonials":
      content.innerHTML += "<br>Testimonials:<br>";
      content.innerHTML += "<blockquote>\"Biswajit is a talented developer who delivered exceptional results on our project.\" - Arjun Dutta, Founder,IQApex Labd</blockquote>";
      content.innerHTML += "<blockquote>\"Working with Biswajit was a great experience. He's a problem solver and a team player.\" - Sattwik Das, Developer</blockquote>";
      // Add more testimonials
      break;

    case "github":
      const githubUsername = "biswajit150803"; // Replace with your GitHub username
    ...
    case "linkedin":
      window.open("https://www.linkedin.com/in/biswajit-ghosh-2b0111219/");
      break;

    case "twitter":
      window.open("https://twitter.com/biswajit150803");
      break;

    case "instagram":
      window.open("https://www.instagram.com/biswajit_1508");
      break;
    ...
    case "cat workexperience.txt":
      content.innerHTML +=
        "<br><span class='work-heading'><b>Backend Lead - GDSC HITK</b></span><br>" +
        "Aug'2023 - Present<br>" +
        "- Leading the web development activities and initiatives within the college.<br>" +
        "- Managing and guiding the members of the Google Developer Student Club (GDSC).<br>" +
        "<br><span class='work-heading'><b>Intern - The Bengal Studio</b></span><br>" +
        "Aug'2023 - Present<br>" +
        "- Manage and build web applications using React JS." +
        "- Collaborate with cross-functional teams to implement features and optimize performance.<br>" +
        "- Explore the exciting realms of Web3 and Solidity for blockchain development.<br>" +
        "<br><span class='work-heading'><b>Ex-Intern - IQApex Labs</b></span><br>" +
        "Jan'23 - Sept'23<br>" +
        "- Developed web applications using React JS.<br>" +
        "- Collaborated with cross-functional teams to implement features and optimize performance.<br>" +
        "- Explored the exciting realms of Web3 and Solidity for blockchain development.<br>" +
        "Enhanced the UI/UX for seamless user experience.<br>";        
      break;
...
function help(console) {
  console.innerHTML +=
    ...
    "testimonials - Get testimonials from people I have worked with<br>" +
